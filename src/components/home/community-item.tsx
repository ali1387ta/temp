  ...
  return (
    <div className="flex flex-col space-y-3">
      ...
      <div className="flex justify-between">
        ...
        <button className="h-8 rounded-full bg-primary-500 px-3 py-1 text-sm font-medium text-black transition-[all_0.2s_cubic-bezier(0.645,0.045,0.355,1)] active:scale-90 disabled:text-zinc-500">
          Check
        </button>
      </div>
    </div>
